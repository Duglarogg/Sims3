...
{
    public class ListingOption : OptionList<IAllowedOccultsOption>, IAliensOption, IOptionItem, IInteractionOptionItem<IActor, GameObject, GameHitParameters<GameObject>>, ICommonOptionItem
    {
